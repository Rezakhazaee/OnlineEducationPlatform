...
namespace BackEnd.Migrations
{
    ...
    [Migration("20260924162726_AddPaymentGatewayFrontendBaseUrl")]
    partial class AddPaymentGatewayFrontendBaseUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Models.CoursePartnerOrganization", b =>
                {
                    ...
                    b.ToTable("CoursePartnerOrganizations");
                });
            ...
            modelBuilder.Entity("BackEnd.Models.Enrollment", b =>
                {
                    ...
                    b.Property<int?>("CoursePartnerOrganizationId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CoursePartnerOrganizationId");
            ...
            modelBuilder.Entity("BackEnd.Models.PaymentGatewaySettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("PaymentBaseUrl")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("BackEnd.Models.StudentFollowUp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BackEnd.Models.CoursePartnerOrganization", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.PartnerOrganization", "PartnerOrganization")
                        .WithMany()
            ...
            modelBuilder.Entity("BackEnd.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.CoursePartnerOrganization", "CoursePartnerOrganization")
                        .WithMany()
                        .HasForeignKey("CoursePartnerOrganizationId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CoursePartnerOrganization");
